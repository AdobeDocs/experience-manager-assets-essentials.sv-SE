...
<table>
    <tr>
        <td>
            <img src="assets/new3.gif" width="20px" height="25px" alt="new">
        ...
        <td>
          ...
          <td>
            <img src="assets/new3.gif" width="20px" height="25px" alt="new">
            <a href="https://experienceleague.adobe.com/sv/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dm-prime-ultimate"><b> Aktivera Dynamic Media Prime och Ultimate </b></a>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <a href="https://experienceleague.adobe.com/sv/docs/experience-manager-assets-essentials/help/custom-search-filters"><b>Dynamiska media med OpenAPI-funktioner</b></a>
        </td>
        <td>
...
Assets Essentials innehåller följande anpassade filter som kan konfigureras om efter behov:
...
>[!MORELIKETHIS]
>
>* [Söka efter resurser](/help/using/search.md)
