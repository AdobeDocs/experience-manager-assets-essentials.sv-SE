---
title: Användargränssnittet [!DNL Assets Essentials]
...
* [Uppgifter](https://experienceleague.adobe.com/docs/experience-manager-assets-essentials/help/my-workspace.html?lang=en): Du kan visa de uppgifter som du har tilldelats på fliken **Mina uppgifter**. De uppgifter du har skapat kan visas på fliken **Tilldelade uppgifter**. Dessutom finns de uppgifter du har slutfört på fliken **Slutförda uppgifter**.
* [Assets](https://experienceleague.adobe.com/docs/experience-manager-assets-essentials/help/manage-organize.html?lang=en): Lista över alla mappar i en trädvy som du har åtkomst till.
...
* ![ikon för gallerivy](assets/do-not-localize/gallery-view.png) [!UICONTROL Gallery View]
* ![Vyikon för vattenfall](assets/do-not-localize/waterfall-view.png) [!UICONTROL Waterfall View]
...
Om du vill navigera i en mapp dubbelklickar du på mappens miniatyrbilder eller väljer mappen i sidopanelen till vänster. Om du vill visa information om en mapp markerar du den och klickar på Information i verktygsfältet högst upp. Använd antingen det vänstra sidofältet eller brödsmulorna högst upp om du vill navigera uppåt och nedåt i hierarkin.

![Bläddra i mappar](assets/browsing-folders.png)

*Bild: Om du vill bläddra i hierarkin använder du de synliga brödsmulorna högst upp eller på sidopanelen till vänster.*

## Förhandsgranska resurser {#preview-assets}

Innan du använder, delar eller hämtar en resurs kan du visa den närmare. Med förhandsgranskningsfunktionen kan du visa inte bara bilderna utan några andra resurstyper som stöds.

Om du vill förhandsgranska en mediefil markerar du den och klickar på ikonen [!UICONTROL Details] ![Detaljer](assets/do-not-localize/edit-in-icon.png) i verktygsfältet högst upp. Du kan inte bara visa resursen utan även visa dess detaljerade metadata och vidta andra åtgärder.

![Förhandsvisa en resurs](assets/preview-asset-2.png)

**A**: Gå tillbaka till den aktuella mappen eller det aktuella sökresultatet i databasen **B**: Namn och format för filen som du förhandsgranskar **C**: Tilldela uppgifter **D**: Avancerade metadata **E**: Nyckelord och smarta taggar **F**: Kommentera och kommentera **G**: Visa aktiviteter relaterade till den valda resursen **H**: Visa och hantera versioner **I**: Visa återgivningar av bilden **J**: Redigera bild **K**: Grundläggande metadata **L**:Avancerade metadata **Nyckelord och smarta taggar** N **: Förhandsgranska mer noggrant.** Zooma, helskärmsläge och andra alternativ **O**: Gå till föregående eller nästa resurs i den aktuella mappen utan att gå tillbaka till mappen

Du kan också förhandsgranska videor.

![Videoförhandsgranskning](/help/using/assets/preview-video.png)

Om du uttryckligen förhandsgranskar en resurs visar [!DNL Assets Essentials] den som en nyligen visad resurs.
...
## Konfigurera visning av kolumner för listvyn Resurser {#configure-columns-list-view}

Du kan markera de kolumner som visas i resurslistvyn, t.ex. Status, Format, Dimensioner, Storlek och så vidare:

1. Välj **[!UICONTROL Assets]** i den vänstra navigeringsrutan, växla till resurslistvyn och klicka på ikonen ![inställningar](assets/settings-icon.svg).

1. Välj de kolumner som du vill visa i listvyn och klicka på **[!UICONTROL Confirm]**.
