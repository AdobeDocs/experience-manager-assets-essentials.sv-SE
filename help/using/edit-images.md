...
[!DNL Assets Essentials] innehåller funktioner för att skapa en ny mall från grunden med [!DNL Adobe Express] inbäddad redigerare Skapa en ny resurs med [!DNL Adobe Expresss]utför du följande steg:

1. Navigera till **[!UICONTROL My Workspace]** och klicka **[!UICONTROL Create]**. [!DNL Adobe Express] tom arbetsyta visas i [!DNL Assets Essentials] användargränssnitt.
