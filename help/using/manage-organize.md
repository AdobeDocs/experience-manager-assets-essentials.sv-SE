...
![Verktygsfältsalternativ när du väljer en resurs](assets/asset-options.png)
...
* [Titta på en video där du kan hantera resurser i Assets Essentials](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/managing.html?lang=sv-SE)
